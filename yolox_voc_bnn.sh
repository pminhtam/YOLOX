...
python -m yolox.tools.train -n yolox-s -d 1 -b 32 -o  --data_dir ~/data/VOCdevkit/ --cache  -expn yolox_s_voc_bnn_fix  --binary_backbone --binary_head --resume  --logger wandb
