#!/bin/bash
#SBATCH --job-name=sOriCCOCO
#SBATCH --output=slurm_yolox_s_coco_c_ori_%A.out
#SBATCH --error=slurm_yolox_s_coco_c_ori_%A.err
#SBATCH --gpus=1
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
export http_proxy=http://proxytc.vingroup.net:9090/
export https_proxy=http://proxytc.vingroup.net:9090/
rm -rf /home/tampm2/.conda/envs/yolox_s_coco_c_ori
conda create --name yolox_s_coco_c_ori python=3.7 --force
